<script>
	...
	function gotofriends() {
		Cookies.set('profileid', userprofile);
		window.location.href = '/Customer/myfriends';
	}
	function gotochat() {
		Cookies.set('msgid', userprofile);
		window.location.href = '/Customer/chat';
	}
	function gotoreviews() {
		Cookies.set('msgid', userprofile);
		window.location.href = '/Customer/restaurantreviews';
	}
	function gotomenu() {
		Cookies.set('msgid', userprofile);
		window.location.href = '/Customer/restaurantmenu';
	}
	function unflw() {
		followstatus = 0;
	...
	function gotofollowers() {
		Cookies.set('profileid', userprofile);
		window.location.href = '/Customer/followerlist';
	}
</script>
...
{#if profileinfo != null}
	...
	{#if profileinfo[5] == 'C'}
		<a href="/Customer/myfriends" on:click={gotofriends}>Friends</a>
	{:else if profileinfo[5] == 'R'}
		<a href="/Customer/followerlist" on:click={gotofollowers}>Followers</a>
	{/if}
	<a href="/Customer/chat" on:click={gotochat}>Message</a>
